...
from ...models.parameters import DataSerializerParameters, FastBinarySerializerParameters
...
class FastBinarySerializer(DataSerializerProtocol):
    ...
    def __init__(self, data_serializer_parameters: DataSerializerParameters) -> None:
        ...
        Args:
            data_serializer_parameters: Configuration parameters
        """
        assert isinstance(data_serializer_parameters, FastBinarySerializerParameters)

        self._fields: dict[str, str] = data_serializer_parameters.fields
        self._compression = data_serializer_parameters.compression
        self._compression_level = data_serializer_parameters.compression_level
        self._n_threads = data_serializer_parameters.n_threads
    ...
    async def __call__(
        ...
        Args:
            source: Async stream of events (dict of numpy arrays)
